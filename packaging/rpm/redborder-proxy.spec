...
Requires: bash ntp dialog dmidecode rsync nc telnet redborder-common redborder-chef-client redborder-rubyrvm rb-register
...
install -D -m 0644 resources/lib/rb_proxy_functions.sh %{buildroot}/usr/lib/redborder/lib
